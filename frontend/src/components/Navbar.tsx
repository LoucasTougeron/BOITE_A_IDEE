      ...
      {mobileOpen && (
        <>
            ...
            {user && (
              <>
                ...
                <button onClick={handleSignOut} disabled={signingOut}
                  className="px-3 py-2.5 rounded-lg text-sm text-red-500 hover:bg-red-50/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 text-left">
          ...
          <div className="hidden md:flex absolute top-full right-4 sm:right-6 mt-2 z-50 w-55 flex-col gap-0.5 rounded-xl border border-[var(--border-medium)] p-1.5 shadow-elevated"
            ...
            <button onClick={handleSignOut} disabled={signingOut}
              className="flex items-center gap-2 px-3 py-2 text-sm text-red-500 hover:bg-red-50/50 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors w-full text-left">
