    ...
    <div className="flex h-[calc(100vh-56px)] page-enter relative">
      ...
      >
        <div className="flex items-center justify-between mb-4 px-1">
          <SectionTitle icon={<Filter size={12} />}>Filtres</SectionTitle>
        ...
        <SectionTitle className="mb-2 px-1">Statut</SectionTitle>
        <div className="flex flex-col gap-0.5 mb-6">
          <button
            onClick={() => setStatus('')}
        ...
        <div className="px-4 sm:px-8 py-6">
            ...
            action={
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="lg:hidden flex items-center justify-center w-9 h-9 rounded-xl border border-[var(--border-light)] text-[var(--text-secondary)] hover:bg-[var(--border-light)] transition-colors"
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Essayez d'autres filtres ou déposez le premier !"
              action={
                hasFilters ? (
                  <Button variant="ghost" onClick={clearFilters}>Effacer les filtres</Button>
                ) : (
                  <Button onClick={() => navigate('/projects/new')}><Plus size={15} /> Déposer un projet</Button>
                )
              }
            />
          ) : view === 'grid' ? (
